...
def _validate_activation(
    ...
    if scientific.get("program")!="sdmr-v5-full-pipeline-integration-v1":
        raise ValueError("wrong integration scientific contract")
    if execution.get("program")!="sdmr-v5-full-pipeline-integration-v1-execution":
    ...
    if confirmation.get("terminal_passed") is not True:
        raise ValueError("v5 confirmation prerequisite did not pass")

#!/usr/bin/env python3
"""Aggregate SDMR v6 full-pipeline integration v2 evidence."""
...
from sdmr.process_id.known_truth.integration_v6 import evaluate_scoped_integration_gate
...
def main() -> None:
    ...
    if scientific.get("program")!="sdmr-v6-full-pipeline-integration-v2":
        raise ValueError("wrong integration scientific contract")
    if activation.get("purpose")!="execute_sdmr_v6_full_pipeline_integration_v2":
    ...
    decision=evaluate_scoped_integration_gate(
        ...
        informative_controls=tuple(scientific["informative_controls"]),

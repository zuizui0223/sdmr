#!/usr/bin/env python3
"""Run one frozen SDMR v3 prospective known-truth shard.
...
def _validate_activation(
    ...
    if not program.startswith("sdmr-v3-prospective-known-truth-v"):
    ...
    expected_execution_program = program + "-execution-profile"
    if execution.get("program") != expected_execution_program:

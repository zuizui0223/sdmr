#!/usr/bin/env python3
"""Run one blocked SDMR v6 prospective known-truth shard."""
...
def _validate_activation(
    ...
    if scientific.get("program")!="sdmr-v6-prospective-known-truth-v1":
        raise ValueError("wrong v6 prospective scientific contract")
    if execution.get("program")!="sdmr-v6-prospective-known-truth-v1-execution":
        raise ValueError("wrong v6 prospective execution profile")
    if activation.get("purpose")!="execute_sdmr_v6_prospective_known_truth_v1":

#!/usr/bin/env python3
"""Aggregate SDMR v5 prospective KT evidence and evaluate frozen KT-A–KT-F."""
    ...
    return {
        ...
        "KT-E":{
            ...
            "min_non_w7_full_system_information_adequacy":float(
                source["KT-E"]["min_non_w7_full_system_authorization_rate"]
            ),
            "max_w7_full_system_information_adequacy":float(
                source["KT-E"]["max_w7_authorized_count"]
            )/float(seed_count),
        },
        "KT-F":{
...
def main() -> None:
    ...
    if scientific.get("program")!="sdmr-v5-prospective-known-truth-v1":
        raise ValueError("wrong v5 prospective contract")

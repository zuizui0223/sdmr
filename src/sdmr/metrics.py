...
def omission_rate_at_training_quantile(
    ...
    *,
    ...
    With the default ``quantile=0.10`` this is the usual OR10-style diagnostic:
    the threshold is the 10th percentile of *training* presence suitability and
    the returned value is the fraction of genuinely independent test presences
    scoring strictly below that threshold.

    OR10 is kept as a conventional model diagnostic. It is not an ecological
    niche-recovery objective and does not alter frozen Product-A v1 selection.
    """

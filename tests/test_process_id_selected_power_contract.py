...
CONTRACT = Path("configs/sdmr_v3_shallow3_positive_power_v1.json")


def test_shallow3_power_contract_freezes_targets_and_curve():
    ...
    assert payload["selected_recovery_target"]["workflow_run"] == 35946188585
    assert payload["selected_recovery_target"]["artifact_id"] == 10787697930

...
from sdmr.activity_specificity_v20_development import (
    V19_RUN_ID,
    V19_TERMINAL_ARTIFACT_ID,
    V19_TERMINAL_DIGEST,
    _config,
)
...
def test_v20_reuses_exact_authoritative_v19_terminal():
    assert V19_RUN_ID == 34604615305
    assert V19_TERMINAL_ARTIFACT_ID == 10266322163
    assert V19_TERMINAL_DIGEST == "sha256:365c3c370f7a735a2f1d8bbf8ff5c71d8523cbc4ddf26ae3622ad813b92c152d"

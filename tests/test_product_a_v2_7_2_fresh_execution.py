...
def test_exact_rank2_empirical_execution_identity_is_frozen():
    ...
    assert c['implementation_sha'] == 'a5c2b4bb3b00581f7eea67327ac9f89074e914bb'
    assert c['frozen_ref'] == 'frozen/product-a-v2-7-2-fresh-confirmation-a5c2b4bb'
    ...
    assert frozen['runtime_design_blob_sha'] == '44d695438ee96eaf8160636b5d4db1f88def2961'
    assert frozen['source_gate_blob_sha_at_runtime_freeze'] == 'b12690710bbca586f6fc3dab9a249532a4147db7'
